...
cp "${INSTALL_DIR}/profiles/good_1n.gamecontroller.amgp" "${ANTIMICROX_PROFILE_DIR}/"

# Substitute placeholder paths with the real install directory.
sed -i "s|__AI_CONTROLLER_DIR__|${INSTALL_DIR}|g" "${ANTIMICROX_PROFILE_DIR}/good_1n.gamecontroller.amgp"
...
# ── 10. INSTALL DESKTOP LAUNCHER (no autostart — launcher app controls services) ──
...
# ── 11. NOTE: Services are NOT auto-started — use the AI Controller launcher app.
echo ""
